...
public class Animation extends JPanel implements MouseMotionListener, MouseListener{
	...
	public Animation(Board b){
		board=b;
		String img_list[]={
    			"CubeImages/bluecrab_0.png",///place actual pictures
    			"CubeImages/bogturtle_left_0.png",
    			"CubeImages/clam_left_1.png",
    			"CubeImages/fish_bass_left.png",
    			"CubeImages/horseshoe_crab_left_1.png"
    	};
    	...
    	backgroundImage = createImage("CubeImages/tempBackGround.jpg");
